...
$MYSQL_CMD dbApimConfig < /dbscripts/mysql.sql
$MYSQL_CMD dbUserstore < /dbscripts/mysql.sql
$MYSQL_CMD dbGovernance < /dbscripts/mysql.sql
$MYSQL_CMD dbApiStatus < /dbscripts/mysql.sql
$MYSQL_CMD dbApiMgt < /dbscripts/apimgt/mysql.sql
